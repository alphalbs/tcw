...
window.onload = function() {
    ...
    function preload () {
		...
		game.load.image('imgQuestion', 'assets/question.png');

		game.load.spritesheet('buttonStart', 'assets/start.png',87,0);
        game.load.spritesheet('button1', 'assets/arrow_next.png',71,0);

        game.load.spritesheet('smallAnswerButton', 'assets/button_small_hover.png',60,0);
		game.load.spritesheet('bigAnswerButton', 'assets/button_big_hover.png',250,0);

		game.load.audio('clapping', 'assets/clapping.ogg');
		game.load.audio('falseError', 'assets/falseError.ogg');
		game.load.audio('pageTurn', 'assets/pageTurn.ogg');
    ...
    var questionsAsked = 40;
    var pointsPh2Question = 30;

    var pointsForBronze = 200;
    var pointsForSilver = 500;
    var pointsForGold = 900;
    ...
    function create () {
        ...
        pageTurn = game.add.audio('pageTurn');
    	...
    	solutionButton2.onOverSound = knock;
    	...
    	solutionButton3.onOverSound = knock;
    	...
    	solutionButton4.onOverSound = knock;
    	...
    	solutionButton5.onOverSound = knock;
    	...
    	solutionButton6.onOverSound = knock;
        ...
        questionsText = game.add.text(623, 20, "", style);
    	...
    	sascha = game.add.sprite(540, 125, 'imgSascha');
    	marlene = game.add.sprite(125, 145, 'imgMarlene');
		emmanuel = game.add.sprite(125, 145, 'imgEmmanuel');
		jenny = game.add.sprite(540, 145, 'imgJenny');
		marius = game.add.sprite(125, 145, 'imgMarius');
		...
		table = game.add.sprite(30, 60, 'imgTable');
		table.visible = false;
		...
		bubble1_2 = game.add.sprite(135, 60, 'bubble2');
        ...
        timerPic = game.add.sprite(457, 13, 'imgSmallTimer');
		timerPic.visible = false;

        questionPic = game.add.sprite(582, 14, 'imgQuestion');
		questionPic.visible = false;

		timeLeftText = game.add.text(500, 20, "", style);
        timeLeftText.visible = false;
	...
	function startGame() {
		console.log(window.parent.global.sound);
		pageTurn.play();
	...
	function createSmallButtons(charNo, attrNo){
		...
		xPos = getSolButtonX(buttonArray[0][2], 0, charNo);
		yPos = getSolButtonY(buttonArray[0][2], 0, charNo);
    	...
    	xPos = getSolButtonX(buttonArray[1][2], 0, charNo);
		yPos = getSolButtonY(buttonArray[1][2], 0, charNo);
    	...
    	xPos = getSolButtonX(buttonArray[2][2], 0, charNo);
		yPos = getSolButtonY(buttonArray[2][2], 0, charNo);
		...
		xPos = getSolButtonX(buttonArray[3][2], 0, charNo);
		yPos = getSolButtonY(buttonArray[3][2], 0, charNo);
		...
		xPos = getSolButtonX(buttonArray[4][2], 0, charNo);
		yPos = getSolButtonY(buttonArray[4][2], 0, charNo);
		...
		xPos = getSolButtonX(buttonArray[5][2], 0, charNo);
		yPos = getSolButtonY(buttonArray[5][2], 0, charNo);
	...
	function createBigButtons(charNo, attrNo){
		...
		xPos = getSolButtonX(buttonArray[0][2], 1, charNo);
		yPos = getSolButtonY(buttonArray[0][2], 1, charNo);
		if(attrNo == 2){
			solutionButton1.loadTexture('smallAnswerButton', 0, 1, 0, 1);
		}
		else{
    	...
    	xPos = getSolButtonX(buttonArray[1][2], 1, charNo);
		yPos = getSolButtonY(buttonArray[1][2], 1, charNo);
		if(attrNo == 2){
			solutionButton2.loadTexture('smallAnswerButton', 0, 1, 0, 1);
		}
		else{
    	...
    	xPos = getSolButtonX(buttonArray[2][2], 1, charNo);
		yPos = getSolButtonY(buttonArray[2][2], 1, charNo);
		if(attrNo == 2){
			solutionButton3.loadTexture('smallAnswerButton', 0, 1, 0, 1);
		}
		else{
		...
		xPos = getSolButtonX(buttonArray[3][2], 1, charNo);
		yPos = getSolButtonY(buttonArray[3][2], 1, charNo);
		if(attrNo == 2){
			solutionButton4.loadTexture('smallAnswerButton', 0, 1, 0, 1);
		}
		else{
		...
		xPos = getSolButtonX(buttonArray[4][2], 1, charNo);
		yPos = getSolButtonY(buttonArray[4][2], 1, charNo);
		if(attrNo == 2){
			solutionButton5.loadTexture('smallAnswerButton', 0, 1, 0, 1);
		}
		else{
		...
		xPos = getSolButtonX(buttonArray[5][2], 1, charNo);
		yPos = getSolButtonY(buttonArray[5][2], 1, charNo);
		if(attrNo == 2){
			solutionButton6.loadTexture('smallAnswerButton', 0, 1, 0, 1);
		}
		else{
	...
	function getSolButtonY(posNo, whichButton, charNo){
		if(whichButton == 0)
		{ //small
			switch(charNo)
			{
				case 0:
					if(posNo == 1){return 290}
					if(posNo == 2){return 370}
					if(posNo == 3){return 290}
					if(posNo == 4){return 370}
					if(posNo == 5){return 290}
					if(posNo == 6){return 370}
					break;
				case 1:
					if(posNo == 1){return 290}
					if(posNo == 2){return 370}
					...
					break;
				case 2:
					if(posNo == 1){return 260}
					if(posNo == 2){return 340}
					if(posNo == 3){return 260}
					if(posNo == 4){return 340}
					if(posNo == 5){return 260}
					if(posNo == 6){return 340}
					break;
				case 3:
					if(posNo == 1){return 270}
					if(posNo == 2){return 350}
					if(posNo == 3){return 270}
					if(posNo == 4){return 350}
					if(posNo == 5){return 270}
					if(posNo == 6){return 350}
					break;
				case 4:
					if(posNo == 1){return 290}
					if(posNo == 2){return 370}
		...
		{ //big
			switch(charNo)
			{
				case 0:
					if(posNo == 1){return 290}
					if(posNo == 2){return 370}
					if(posNo == 3){return 450}
					if(posNo == 4){return 287}
					if(posNo == 5){return 367}
					if(posNo == 6){return 447}
					break;
				case 1:
					if(posNo == 1){return 280}
					if(posNo == 2){return 360}
					if(posNo == 3){return 440}
					if(posNo == 4){return 277}
					if(posNo == 5){return 357}
					if(posNo == 6){return 437}
					break;
				case 2:
					if(posNo == 1){return 265}
					if(posNo == 2){return 345}
					if(posNo == 3){return 425}
					if(posNo == 4){return 262}
					if(posNo == 5){return 342}
					if(posNo == 6){return 422}
					break;
				case 3:
					if(posNo == 1){return 265}
					if(posNo == 2){return 345}
					...
					break;
				case 4:
					if(posNo == 1){return 285}
					if(posNo == 2){return 365}
					if(posNo == 3){return 445}
					if(posNo == 4){return 283}
					if(posNo == 5){return 363}
					if(posNo == 6){return 443}
					break;
			}
		}
	}

	function getSolButtonX(posNo, whichButton, charNo){
		if(whichButton == 0)
		{ //small
			switch(charNo)
			{
				case 0:
					if(posNo == 1){return game.world.centerX + 135}
					if(posNo == 2){return game.world.centerX + 135}
					if(posNo == 3){return game.world.centerX + 35}
					if(posNo == 4){return game.world.centerX + 35}
					if(posNo == 5){return game.world.centerX - 65}
					if(posNo == 6){return game.world.centerX - 65}
					break;
				case 1:
					if(posNo == 1){return game.world.centerX + 135}
					if(posNo == 2){return game.world.centerX + 135}
					...
					break;
				case 2:
					if(posNo == 1){return game.world.centerX - 25}
					if(posNo == 2){return game.world.centerX - 25}
					if(posNo == 3){return game.world.centerX - 125}
					if(posNo == 4){return game.world.centerX - 125}
					if(posNo == 5){return game.world.centerX - 225}
					if(posNo == 6){return game.world.centerX - 225}
					break;
				case 3:
					if(posNo == 1){return game.world.centerX - 25}
					if(posNo == 2){return game.world.centerX - 25}
		...
		{ //big
			...
			{
				case 0:
					if(posNo == 1){return game.world.centerX - 140}
					if(posNo == 2){return game.world.centerX - 140}
					if(posNo == 3){return game.world.centerX - 140}
					if(posNo == 4){return game.world.centerX + 120}
					if(posNo == 5){return game.world.centerX + 120}
					if(posNo == 6){return game.world.centerX + 120}
					break;
				case 1:
					if(posNo == 1){return game.world.centerX - 140}
					if(posNo == 2){return game.world.centerX - 140}
					...
					break;
				case 2:
					if(posNo == 1){return game.world.centerX - 385}
					if(posNo == 2){return game.world.centerX - 385}
					if(posNo == 3){return game.world.centerX - 385}
					if(posNo == 4){return game.world.centerX - 125}
					if(posNo == 5){return game.world.centerX - 125}
					if(posNo == 6){return game.world.centerX - 125}
					break;
				case 3:
					if(posNo == 1){return game.world.centerX - 385}
					if(posNo == 2){return game.world.centerX - 385}
	...
	function endGame(){
		...
		smallTrophy.visible = false;
		questionPic.visible = false;
		if(gamePoints > pointsForBronze){
			endText.setText('Glückwunsch!\nDu hast dir die Goldmedaille verdient!');
		}
		else if(gamePoints > pointsForSilver){
			endText.setText('Glückwunsch!\nDu hast dir die Silbermedaille verdient!');
		}
		else if(gamePoints > pointsForGold){
			endText.setText('Glückwunsch!\nDu hast dir die Bronzemedaille verdient!');
		}
		else{
			endText.setText('Schade!\nDu hast dir leider keine Medaille verdient.');
		}
	}
